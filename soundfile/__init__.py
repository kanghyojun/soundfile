...
class CheapMP3(object):
    ...
    .. sourcecode:: python
       ...
       cheap = CheapMP3('filepath.mp3')
       with cheap.read() as mp3:
           print(mp3.frame_offsets)
    """
    ...
    #: channel of :attr:`file`
    channels = 0

    #: sample rate of :attr:`file`
    sample_rate = 0
    ...
    def grow(self, name, size):
        """Grow size of array as much as :param size: .

        :param name: name of attribute you want to grow.
        :param size: size of array you want to grow.
        """
        i = 0
        while i < size:
    ...
    @contextmanager
    def read(self):
        """Read gains, offsets, lens from given :attr:`file`
        if :attr:`file` isn't readed yet. you can use like
